...
function draw() {
    ...
    const colorDark = '#a3573a';
    const colorLight = '#cd8b62';
    const colorBackground = '#f7efd2';
    ...
    if (gameOver) {
        let boxWidth = 500;
        let boxHeight = 100;
        let boxX = 300 - boxWidth / 2;
        let boxY = 270 - boxHeight / 2;
